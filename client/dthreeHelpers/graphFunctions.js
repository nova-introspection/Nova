...
export default {
    ...
    links: {
        ...
        addPath: (link) => {
            link.attr("class", "link")
                ...
                .style("stroke", (d) => { 
                    ...
                    return d3.rgb(color(col)).darker(.5); 
                })
        ...
        isConnected: (a, b, obj) => {
            return obj[`${a.index},${b.index}`] || obj[`${b.index},${a.index}`] || a.index === b.index;
        }
    },
    nodes: {
    ...
    ticks: {
        positionNode: (d) => { return "translate(" + d.x + "," + d.y + ")"; },
        linkArrowArc: (d) => {
            ...
            var offX = midpoint_x + offset*(diffY/pathLength);
            var offY = midpoint_y - offset*(diffX/pathLength);
